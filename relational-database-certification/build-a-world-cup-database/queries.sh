...
echo "$($PSQL "SELECT name FROM teams LEFT JOIN games ON teams.team_id=games.winner_id OR teams.team_id=opponent_id WHERE games.year=2014 AND games.round='Eighth-Final' ORDER BY name")"
